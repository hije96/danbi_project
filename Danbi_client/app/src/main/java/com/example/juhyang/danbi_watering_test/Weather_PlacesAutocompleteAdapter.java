 ...
 */
public class Weather_PlacesAutocompleteAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public Weather_PlacesAutocompleteAdapter(Context context, int textViewResourceId) {
